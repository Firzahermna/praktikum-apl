...
int main() {
    ...
    do {
        ...
        case 4:
            ...
            break;
        case 5:
            urutNama(daftarGaming, totalData);
            lihatData(daftarGaming, totalData);
            break;
        case 6:
            urutHarga(daftarGaming, totalData);
            lihatData(daftarGaming, totalData);
            break;
        case 7:
            urutStok(daftarGaming, totalData);
            lihatData(daftarGaming, totalData);
            break;
        case 8:
            cariNama(daftarGaming, totalData);
            break;
        case 9:
            cariHarga(daftarGaming, totalData);
            break;
        case 10:
